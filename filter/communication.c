...
--*/
{
	...
	PVOID abcconnectionCookie = ExAllocatePoolWithTagPriority(PagedPool,
		sizeof(AVSCAN_CONNECTION_TYPE),
		AV_CONNECTION_CTX_TAG ,NormalPoolPriority);
	RtlZeroMemory(
		abcconnectionCookie, sizeof(AVSCAN_CONNECTION_TYPE));
	connectionCookie=(PAVSCAN_CONNECTION_TYPE)abcconnectionCookie;
